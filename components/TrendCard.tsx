...
const TrendCard: React.FC<TrendCardProps> = ({ trend }) => {
    return (
        <article className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 flex flex-col overflow-hidden">
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-brand-dark mb-4 flex-grow">
                    {trend.snippet}
                </p>
                <a
